...
public class SendLoadPrio implements JavaDelegate {
    @Override
    public void execute(DelegateExecution execution) throws Exception {
        ...
        data.put("PRIORITIES", execution.getVariable("PRIORITIES"));
        data.put("NUM_DAYS_MIN", execution.getVariable("NUM_DAYS_MIN"));
        ...
        service.correlateMessage("Sende Prio", data);
    }
}
